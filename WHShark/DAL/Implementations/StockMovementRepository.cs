...
namespace DAL.Implementations
{
    public sealed class StockMovementRepository : IStockMovementRepository
    {
        ...
        public void Add(StockMovement obj)
        {
            ...
            {
                throw new Exception("An error occurred while inserting stock movement data.", ex);
            }
        }
        ...
        public void Update(StockMovement obj)
        {
            ...
            {
                throw new Exception("An error occurred while updating stock movement data.", ex);
            }
        }
        ...
        public void Delete(Guid id)
        {
            ...
            {
                throw new Exception("An error occurred while deleting stock movement data.", ex);
            }
        }
        ...
        public IEnumerable<StockMovement> SelectAll()
        {
            ...
            {
                throw new Exception("An error occurred while selecting all stock movements.", ex);
            }
            return list;
        }
        ...
        public StockMovement SelectOne(Guid id)
        {
            ...
            {
                throw new Exception("An error occurred while selecting a stock movement by id.", ex);
            }
            return sm;
        }
    }
